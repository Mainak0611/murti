...
//   // --- UPDATED FETCH LOGIC ---
//   // Added isBackground parameter. Default is false (show loader).
//   // If true (passed from edit/delete), we don't trigger setLoading(true).
...
//     } finally {
//       // Always turn off loading, just in case
//       setLoading(false);
//     }
//   };

//   useEffect(() => {
//     fetchEnquiries(); // Initial load (shows spinner)
//   }, []);
...
//         <PartyEnquiryForm
//           onSuccess={() => fetchEnquiries(false)} // Form success can still do full load if desired, or set to true for background
//           showToast={showToast}
//         />
